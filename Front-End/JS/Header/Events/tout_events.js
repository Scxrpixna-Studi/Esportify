document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    const res = await fetch("/users/events_en_cours", {
      credentials: "include"
    });
    ...
    function afficherEvents(container, messageVide) {
      ...
      data.demandes.forEach(demande => {
        ...
        container.appendChild(articleEvent);
    ...
    // 🔹 Appels pour les deux sections
    afficherEvents(containerEventsEnCours, aucunEvents);
    afficherEvents(toutEvents, aucunEventsContent);
